...
echo ""
echo "If launchd.err.log shows PermissionError reading pyvenv.cfg,"
echo "your venv is still under ~/Documents (TCC-protected). Fix it with:"
echo "  ./migrate-venv.command"
